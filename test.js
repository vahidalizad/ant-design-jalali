...
describe("moment", function () {
  describe("#parse", function () {
    ...
    it("should parse correctly when input is only time", function () {
      ...
      jm.format("YYYY-MM-DD hh:mm:ss").should.be.equal(
    ...
    it("should be able to parse in utc", function () {
      ...
      m.format("YYYY-MM-DD hh:mm:ss Z").should.be.equal(
        "1981-08-17 07:10:20 +00:00"
      );
    });
  ...
  describe("#format", function () {
    ...
    it("should format with escaped and unescaped tokens", function () {
      ...
      m.format("[My] birt\\h [is] jYYYY or YYYY").should.be.equal(
        "My birth is 1360 or 1981"
      );
    });

    it("should format with mixed tokens", function () {
      var m = jalaliMoment("1981-08-17", "YYYY-MM-DD");
      m.format("jYYYY/jMM/jDD = YYYY-MM-DD").should.be.equal(
        "1360/05/26 = 1981-08-17"
      );
    });
  ...
  describe("#startOf", function () {
    ...
    it("should return start of Jalaali year, month and date", function () {
      ...
      m.startOf("jweek")
        .format("jYYYY-jMM-jDD HH:mm:ss")
        .should.be.equal("1396-09-18 00:00:00");
      m.locale("fa")
        .startOf("week")
        .format("jYYYY-jMM-jDD HH:mm:ss")
        .should.be.equal("1396-09-18 00:00:00");
  ...
  describe("#isValid", function () {
    it("should return true when a valid date is parsed and false otherwise", function () {
      ...
      jalaliMoment("1360 Mordaad 26", "jYYYY jMMMM jD")
        .isValid()
  ...
  describe("#add", function () {
    ...
    it("should add jalaali dates correctly", function () {
      ...
      jalaliMoment(m)
        .add(10, "jmonths")
        .format(jf)
        .should.be.equal("1361/3/26");
      jalaliMoment(m)
        .add(20, "jmonths")
        .format(jf)
        .should.be.equal("1362/1/26");
  ...
  describe("#subtract", function () {
    it("should subtract gregorian dates correctly", function () {
      ...
      jalaliMoment(m)
        .subtract(1, "day")
        .format(gf)
        .should.be.equal("1981-8-16");
      jalaliMoment(m)
        .subtract(10, "days")
        .format(gf)
        .should.be.equal("1981-8-7");
      jalaliMoment(m)
        .subtract(30, "days")
        .format(gf)
        .should.be.equal("1981-7-18");
      jalaliMoment(m)
        .subtract(60, "days")
        .format(gf)
        .should.be.equal("1981-6-18");

      jalaliMoment(m)
        .subtract(1, "month")
        .format(gf)
        .should.be.equal("1981-7-17");
      jalaliMoment(m)
        .subtract(2, "months")
        .format(gf)
        .should.be.equal("1981-6-17");
      jalaliMoment(m)
        .subtract(10, "months")
        .format(gf)
        .should.be.equal("1980-10-17");
      jalaliMoment(m)
        .subtract(20, "months")
        .format(gf)
        .should.be.equal("1979-12-17");

      jalaliMoment(m)
        .subtract(1, "year")
        .format(gf)
        .should.be.equal("1980-8-17");
      jalaliMoment(m)
        .subtract(2, "years")
        .format(gf)
        .should.be.equal("1979-8-17");
      jalaliMoment(m)
        .subtract(10, "years")
        .format(gf)
        .should.be.equal("1971-8-17");
      jalaliMoment(m)
        .subtract(20, "years")
        .format(gf)
        .should.be.equal("1961-8-17");
    });
    ...
    it("should subtract jalaali dates correctly", function () {
      ...
      jalaliMoment(m)
        .subtract(1, "day")
        .format(jf)
        .should.be.equal("1360/5/25");
      jalaliMoment(m)
        .subtract(4, "days")
        .format(jf)
        .should.be.equal("1360/5/22");
      jalaliMoment(m)
        .subtract(10, "days")
        .format(jf)
        .should.be.equal("1360/5/16");
      jalaliMoment(m)
        .subtract(30, "days")
        .format(jf)
        .should.be.equal("1360/4/27");
      jalaliMoment(m)
        .subtract(60, "days")
        .format(jf)
        .should.be.equal("1360/3/28");
      jalaliMoment(m)
        .subtract(365, "days")
        .format(jf)
        .should.be.equal("1359/5/26");

      jalaliMoment(m)
        .subtract(1, "jmonth")
        .format(jf)
        .should.be.equal("1360/4/26");
      jalaliMoment(m)
        .subtract(2, "jmonths")
        .format(jf)
        .should.be.equal("1360/3/26");
      jalaliMoment(m)
        .subtract(10, "jmonths")
        .format(jf)
        .should.be.equal("1359/7/26");
      jalaliMoment(m)
        .subtract(20, "jmonths")
        .format(jf)
        .should.be.equal("1358/9/26");
      ...
      jalaliMoment(m)
        .subtract(2, "jyears")
        .format(jf)
        .should.be.equal("1358/5/26");
      jalaliMoment(m)
        .subtract(3, "jyears")
        .format(jf)
        .should.be.equal("1357/5/26");
      jalaliMoment(m)
        .subtract(4, "jyears")
        .format(jf)
        .should.be.equal("1356/5/26");
      jalaliMoment(m)
        .subtract(10, "jyears")
        .format(jf)
        .should.be.equal("1350/5/26");
      jalaliMoment(m)
        .subtract(20, "jyears")
        .format(jf)
        .should.be.equal("1340/5/26");
    });
    ...
    it("should retain last day of month when subtracting months or years", function () {
      ...
      jalaliMoment(m)
        .subtract(1, "jmonth")
        .format(jf)
        .should.be.equal("1392/12/29");
      jalaliMoment(m)
        .subtract(6, "jmonth")
        .format(jf)
        .should.be.equal("1392/7/30");
      jalaliMoment(m)
        .subtract(7, "jmonth")
        .format(jf)
        .should.be.equal("1392/6/31");

      m = jalaliMoment("1391/12/30", jf);
      jalaliMoment(m)
        .subtract(1, "jyear")
        .format(jf)
        .should.be.equal("1390/12/29");
      jalaliMoment(m)
        .subtract(2, "jyear")
        .format(jf)
        .should.be.equal("1389/12/29");
      jalaliMoment(m)
        .subtract(3, "jyear")
        .format(jf)
        .should.be.equal("1388/12/29");
      jalaliMoment(m)
        .subtract(4, "jyear")
        .format(jf)
        .should.be.equal("1387/12/30");
    });
    ...
    it("should subtract months correctly", function () {
      ...
      jalaliMoment(m)
        .subtract(12, "jmonth")
        .format(jf)
        .should.be.equal("1392/1/31");
      jalaliMoment(m)
        .subtract(13, "jmonth")
        .format(jf)
        .should.be.equal("1391/12/30");
      jalaliMoment(m)
        .subtract(25, "jmonth")
        .format(jf)
        .should.be.equal("1390/12/29");
      ...
      jalaliMoment(m)
        .subtract(1, "jmonth")
        .format(jf)
        .should.be.equal("1392/12/1");
      jalaliMoment(m)
        .subtract(2, "jmonth")
        .format(jf)
        .should.be.equal("1392/11/1");
      jalaliMoment(m)
        .subtract(7, "jmonth")
        .format(jf)
        .should.be.equal("1392/6/1");
      jalaliMoment(m)
        .subtract(12, "jmonth")
        .format(jf)
        .should.be.equal("1392/1/1");
      jalaliMoment(m)
        .subtract(13, "jmonth")
        .format(jf)
        .should.be.equal("1391/12/1");
      jalaliMoment(m)
        .subtract(25, "jmonth")
        .format(jf)
        .should.be.equal("1390/12/1");

      m = jalaliMoment("1393/1/10", jf);
      jalaliMoment(m)
        .subtract(1, "jmonth")
        .format(jf)
        .should.be.equal("1392/12/10");
      jalaliMoment(m)
        .subtract(2, "jmonth")
        .format(jf)
        .should.be.equal("1392/11/10");
      jalaliMoment(m)
        .subtract(7, "jmonth")
        .format(jf)
        .should.be.equal("1392/6/10");
      jalaliMoment(m)
        .subtract(12, "jmonth")
        .format(jf)
        .should.be.equal("1392/1/10");
      jalaliMoment(m)
        .subtract(13, "jmonth")
        .format(jf)
        .should.be.equal("1391/12/10");
      jalaliMoment(m)
        .subtract(25, "jmonth")
        .format(jf)
        .should.be.equal("1390/12/10");
    });
  });
  ...
  describe("#isSame", function () {
    it("should work correctly for same year", function () {
      ...
      m1.isSame(
        jalaliMoment("2016-02-04", "YYYY-MM-DD"),
        "day"
      ).should.be.equal(true);
    });
  ...
  describe("test utc time", function () {
    it("utc jalaliMoment", function () {
      jalaliMoment.locale("en");
      var m1 = jalaliMoment("1395/12/30", "jYYYY/jMM/jDD", "fa", true).locale(
        "fa"
      );
      m1.format("YYYY/MM/DD").should.be.equal("1395/12/30");
    });
  ...
  describe("use gregorian calendar parser in 'fa' locale", function () {
    it("use jalali calendar when useGregorianParser is false in fa locale", function () {
      ...
      jalaliMoment("1370-10-17")
        .format("YYYY-MM-DD")
        .should.be.equal("1370-10-17");
    });
    it("parse using gregorian calendar in fa locale", function () {
      jalaliMoment.locale("fa", { useGregorianParser: true });
      jalaliMoment("2019-01-17T08:19:19.975Z")
        .format("YYYY-MM-DD")
        .should.be.equal("1397-10-27");
      jalaliMoment("2019-02-23")
        .format("YYYY-MM-DD")
        .should.be.equal("1397-12-04");
    });
  });
